  ...
  return (
    <div className=' relative'>
      ...
      <span className=' absolute right-0 top-[-5%] md:hidden block'>
        <img className=' md:w-[106px] w-[41px] md:h-[113px] h-[44px]' src={vector1} alt="vector" />
      </span>
      <div className='my-container mx-auto sm:pt-12 pt-[152px] md:pt-24 overflow-hidden'>
        <div className="flex flex-wrap flex-row items-center pb-14 md:pb-12">
          <div className='w-full md:w-1/3 flex justify-center md:justify-start'>
              <img className=' w-[249] h-[36px]' src={footerlogo} alt="footerlogo" />
          </div>
          <div className='w-full md:w-1/3 flex justify-center md:mt-4 mt-9 lg:mt-0 '>
            <ul className='flex gap-6 items-center'>
              <li><a href="/home" className='font-normal text-base text-black opacity-[70%]'>Home</a></li>
              <li><a href="/how-it-works" className='font-normal text-base text-black opacity-[70%]'>How It Works</a></li>
              <li><a href="/features" className='font-normal text-base text-black opacity-[70%]'>Features</a></li>
            </ul>
          </div>
        ...
        <p className='font-normal text-sm text-black opacity-[70%] text-center py-4'>© 2024 Cell Tracker. All Rights Reserved.</p>
      </div>
    </div>
  )
}
