...
import { Dotedline } from '../common/Icon'
  ...
  return (
    <>
      <div className=' my-container mx-auto sm:pt-[98px] pt-24'>
        ...
        Fames tincidunt pellentesque nisl blandit at sit. Ullamcorper nisi sit elit rhoncus vestibulum fames libero id.        </p>
        <div className=' flex flex-wrap flex-row justify-center relative pt-[56px]'>
          ...
          {worksData.map((item, index) => ( 
            <div key={index} className={` ${index == 0 ? "lg:items-start items-center" : index == 1 ? "items-center pt-[151px] sm:pt-0" : index == 2 ? "lg:items-end items-center pt-[151px] lg:pt-0" : ""} flex flex-col lg:w-1/3 sm:w-1/2 w-full`}>
              <div className=''>
